...
describe('paragraph text-style inheritance', () => {
  test('scales document-sized images without distorting their aspect ratio', () => {
    const style = responsiveImageSizeStyle(523, 407);

    expect(style).toBe('max-width:100%;height:auto;width:523px;aspect-ratio:523/407;');
    expect(style).not.toContain('height:407px');
  });
